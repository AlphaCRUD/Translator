...
public final class AdUnifiedSmallBinding implements ViewBinding {
  ...
  private AdUnifiedSmallBinding(@NonNull NativeAdView rootView, @NonNull TextView adAdvertiser,
      ...
      @NonNull RatingBar adStars, @NonNull TextView adStore, @NonNull LinearLayout btn,
      @NonNull TextView tv) {
  ...
  @NonNull
  public static AdUnifiedSmallBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdUnifiedSmallBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.ad_unified_small, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdUnifiedSmallBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdUnifiedSmallBinding((NativeAdView) rootView, adAdvertiser, adAppIcon, adBody,
          adCallToAction, adHeadline, adMedia, adPrice, adStars, adStore, btn, tv);
    }
