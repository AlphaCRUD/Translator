...
public class Adds extends AppCompatActivity {
    ...
    ImageButton loadInterstitialBtn;
...
//        new RequestConfiguration.Builder().setTestDeviceIds(Arrays.asList("56FA14F9400CEC59FE483A70F49DAEF8"));
        ...
        loadInterstitialBtn = findViewById(R.id.loadInterstitialBtn);
        loadInterstitialBtn.setVisibility(View.GONE);

        loadInterstitialBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                linearprogress.setVisibility(View.VISIBLE);
                loadAd();
        ...
        InterstitialAd.load(
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        // an ad is loaded.
                        Adds.this.interstitialAd = interstitialAd;
                        ...
                        interstitialAd.setFullScreenContentCallback(
                                new FullScreenContentCallback() {
                                    ...
                                    public void onAdFailedToShowFullScreenContent(AdError adError) {
                                        ...
                                        Adds.this.interstitialAd = null;
                                        linearprogress.setVisibility(View.GONE);
                                        loadInterstitialBtn.setVisibility(View.VISIBLE);
                    ...
                    public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                        ...
                        Toast.makeText(Adds.this, error, Toast.LENGTH_SHORT).show();
                    }
